...
const LegalPage = () => {
  return (
    <MainLayout isSmallLogo={true} isNavigationTransparent={false}>
      <Content>
        <Section>
          <h1>Legal notice</h1>
          Due to the german law I have to provide a legal notice. The further
          ...
          <br />
          Telefon: (+49) 176 / 24071062
          <br />
          E-Mail: mail(at)uullrich.com
          <br />
          Web: uullrich.com <br />
          <br />
          ...
          verantwortlichen Anbieter [Uwe Ullrich, Klosterstraße 22, 73230
          Kirchheim unter Teck] auf dieser Website (im folgenden “Angebot”) auf.
          ...
          bestimmbar ist, also Angaben, die zurück zu einer Person verfolgt
          werden können. Dazu gehören der Name, die Emailadresse oder die
          ...
          Sie können mich auf elektronischem Wege über das Kontaktformular
          kontaktieren, bspw. um mir Feedback mitzuteilen oder um mir Fragen zu
          stellen. Wenn Sie diese Möglichkeit nutzen, übermitteln Sie folgende
          Daten an mich:
          <ul>
          ...
          Zusätzlich zu den Daten, die Sie mir freiwillig mitteilen, speichere
          ich den Zeitpunkt (Datum und Uhrzeit) der Übermittlung Ihrer Daten an
          mich, sowie Ihre IP-Adresse. Die Verarbeitung dieser Daten entspricht
          meinem berechtigten Interesse (Art. 6 (1) lit. f DS-GVO), um die
          Sicherheit unserer Systeme zu gewährleisten und Missbrauch
          entgegenzuwirken. Diese Daten, die ich während Ihrer Kontaktaufnahme
          zusätzlich erheben, werden gelöscht, sobald sie nicht mehr benötigt
          werden, spätestens das Anliegen Ihrer Kontaktaufnahme umfassend
          geklärt ist. <br />
          <br />
          Mit dem Absenden des Kontaktformulars stimmen Sie der Verarbeitung
          Ihrer Daten durch mich zu. Die Rechtsgrundlage für die Verarbeitung
          Ihrer Daten zum Zwecke der Bearbeitung Ihrer Kontaktaufnahme ist Art.
          6 (1) lit. a DS-GVO. Die Daten werden gespeichert, bis sie zur
          Erreichung des Zwecks der Konversation mit Ihnen nicht mehr
          erforderlich sind und das Anliegen Ihrer Kontaktaufnahme umfassend
          geklärt ist. <br />
          <br />
          Wenn Ihre Kontaktaufnahme darauf abzielt, einen Vertrag mit mir
          abzuschließen, ist die zusätzliche Rechtsgrundlage für die
          Verarbeitung Ihrer personenbezogenen Daten Art. 6 (1) lit. b DS-GVO.
          ...
          der E-Mail übermittelten personenbezogenen Daten werden bei mir
          gespeichert. Eine Weitergabe der Daten an Dritte erfolgt nicht. Die
          Daten werden ausschließlich verarbeitet, um Ihre Kontaktaufnahme zu
          bearbeiten. Die Rechtsgrundlage für die Verarbeitung Ihrer
          personenbezogenen Daten ist Art. 6 (1) lit. f DS-GVO. Die Daten werden
          gespeichert, bis sie zur Erreichung des Zwecks der Konversation mit
          Ihnen nicht mehr erforderlich sind und das Anliegen Ihrer
          Kontaktaufnahme umfassend geklärt ist.
          <br />
          <br />
          Wenn Ihre E-Mail darauf abzielt, einen Vertrag mit mir abzuschließen,
          ist die zusätzliche Rechtsgrundlage für die Verarbeitung Ihrer
          personenbezogenen Daten Art. 6 (1) lit. b DS-GVO. Diese Daten werden
          so lange gespeichert, wie sie zur Durchführung des Vertrags
          erforderlich sind. Darüberhinausgehend speichere ich Ihre Daten nur um
          vertraglichen oder gesetzlichen Verpflichtungen (z.B. steuerlichen
          Pflichten) nachzukommen.
          <br />
          <br />
          Sie können die Einwilligung in die Verarbeitung Ihrer
          personenbezogenen Daten jederzeit widerrufen, indem Sie mir dies per
          Mail an „mail(at)uullrich.com“ mitteilen. In diesem Fall werden alle
          personenbezogenen Daten der Konversation gelöscht und eine Fortführung
          der Konversation ist nicht möglich.
          <h3>Kommentare und Beiträge</h3>
          Wenn Nutzer Kommentare im Blog oder sonstige Beiträge hinterlassen,
          werden ihre IP-Adressen gespeichert. Das erfolgt zur Sicherheit des
          Anbieters, falls jemand in Kommentaren und Beiträgen widerrechtliche
          Inhalte schreibt (Beleidigungen, verbotene politische Propaganda,
          etc.). In diesem Fall kann der Anbieter selbst für den Kommentar oder
          Beitrag belangt werden und ist daher an der Identität des Verfassers
          interessiert.
          ...
          Nutzer wahr nehmen. Denn ohne die IP-Adresse, könnten sie die Inhalte
          nicht an den Browser des jeweiligen Nutzers senden. Die IP-Adresse ist
          ...
          IP-Adresse lediglich zur Auslieferung der Inhalte verwenden. Jedoch
          haben wir keinen Einfluss darauf, falls die Dritt-Anbieter die
          IP-Adresse z.B. für statistische Zwecke speichern. Soweit dies uns
          ...
          <br />
          Auf meiner Website verwende ich das Content Delivery Network ("CDN")
          „AWS CloudFront“ des Dienstanbieters „Amazon“ (Amazon EU S.a. r.l., 38
          avenue John F. Kennedy, L-1855 Luxemburg). Bei einem Content Delivery
          Network handelt es sich um einen Online-Dienst, mit dessen Hilfe
          insbesondere große Mediendateien (wie z.B. Grafiken, Seiteninhalte
          oder Skripte) durch ein Netz regional verteilter und über das Internet
          verbundener Server ausgeliefert werden. Der Einsatz des Content
          Delivery Network von Amazon hilft mir bei der Optimierung der
          Ladegeschwindigkeiten meiner Website. Die Verarbeitung erfolgt gemäß
          Art. 6 Abs. 1 lit. f DSGVO auf Basis meines berechtigten Interesses an
          einer sicheren und effizienten Bereitstellung, sowie Verbesserung der
          Stabilität und Funktionalität meiner Website. Weitere Informationen
          finden Sie in der Datenschutzerklärung von Amazon unter
